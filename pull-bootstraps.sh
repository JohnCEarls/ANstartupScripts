...
aws s3 cp s3://aurea-nebula/aws-meta/working-files/data-dev-bootstrap.sh .
aws s3 cp s3://aurea-nebula/aws-meta/working-files/master-bootstrap.sh .
aws s3 cp s3://aurea-nebula/aws-meta/working-files/master-dev-bootstrap.sh .
aws s3 cp s3://aurea-nebula/aws-meta/working-files/web-bootstrap.sh .
aws s3 cp s3://aurea-nebula/aws-meta/working-files/web-dev-bootstrap.sh .
aws s3 cp s3://aurea-nebula/aws-meta/working-files/root-web-bootstrap.sh .
aws s3 cp s3://aurea-nebula/aws-meta/working-files/root-web-dev-bootstrap.sh .
aws s3 cp s3://aurea-nebula/aws-meta/working-files/gpu-bootstrap.sh .
aws s3 cp s3://aurea-nebula/aws-meta/working-files/gpu-dev-bootstrap.sh .
